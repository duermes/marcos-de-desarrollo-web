    ...
    public void init() {
        if (bookRepository.count() == 0) {
            List<Book> books = Arrays.asList(
                    new Book(1, "DIARIO DE GREG 1 (TD). UN RENACUAJO", "En primer lugar, quiero dejar una cosa bien clara: esto no es un diario. Ya sé lo que pone en la portada. Mira que cuando Mamá lo fue a comprar le pedí DE MANERA ESPECÍFICA que si compraba una libreta no tuviera el rotulito de diario». Greg Heffley tiene 12 años y su madre le compra un diario que abarcará un curso escolar: de septiembre a junio.",
